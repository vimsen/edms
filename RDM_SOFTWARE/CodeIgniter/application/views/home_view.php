		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                                               ...
                                               <!-- <li><a href="head"><i class="icon-tasks"></i><span class="hidden-tablet"> Head</span></a></li> -->
						 <!-- <li><a href="mdm"><i class="icon-tasks"></i><span class="hidden-tablet"> Mdm</span></a></li>-->
                                               <!--   <li><a href="dass"><i class="icon-tasks"></i><span class="hidden-tablet"> Dass</span></a></li>-->
                                            <?php
			...
			<div class="row-fluid">
				...
				<div class="span8 widget blue" onTablet="span7" onDesktop="span8">
					...
					<div id="stats-chart2"  style="min-height:282px" ></div>
